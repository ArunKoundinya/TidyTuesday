---
title: Tidy Tuesday  - Carbon Majors Emissions Data
subtitle: 21st May 2024
date: "2024-06-08"
format: html
fig-dpi: 300
execute:
...
# Creating new columns for better visualization
emissions <- 
  emissions |> 
  mutate(
...
## 3.1. 1.42 Trillion Tonnes of CO2 Emissions 

```{python}
#| label: plot1-area-plot
#| warning: false
#| eval: false
#| code-fold: true
...
# Plot1 - Area Chart with background image
...
## 3.2. 0.5 Trillion Tonnes of CO2 Emitted by Each Entity Group

```{python}
#| label: plot2-line-plot
#| warning: false
#| eval: false
#| code-fold: true
...
-   https://stackoverflow.com/questions/70924495/how-to-add-several-vertical-lines-to-ggplot2-in-r
-   https://r-graph-gallery.com/136-stacked-area-chart.html
-   https://imagecolorpicker.com
-   https://stackoverflow.com/questions/2954005/how-to-move-or-position-a-legend-in-ggplot2
